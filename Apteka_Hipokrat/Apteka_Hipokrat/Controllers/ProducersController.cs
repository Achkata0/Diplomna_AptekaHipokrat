...
namespace Apteka_Hipokrat.Controllers
{
    public class ProducersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Country,Description")] Producer producer)
        {
            if (ModelState.IsValid)
            {
                //producer.RegisterON = DateTime.Now; 
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Country,Description")] Producer producer)
        {
            if (id != producer.Id)
            {
                return NotFound();
